...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      // Game families + mechanic variants — shown per stage on the world map.
      'game_quest_path': 'Quest',
      'game_goal_shootout': 'Stadium',
      'game_draw_connect': 'Connections',
      'game_number_city': 'My Town',
      'game_scene_play': 'Wonder Lab',
      'variant_draw_pass': 'Draw the Pass',
      'variant_keeper_save': 'Keeper',
      'variant_bridge_builder': 'Bridge',
      'variant_lantern_lights': 'Lanterns',
      'variant_sort_streams': 'Sort It',
      'world_new': 'New World',
      'world_pick_lesson': 'Pick a lesson',
      'world_own_topic': 'My own topic',
      'world_own_topic_hint': 'What do you want to learn about?',
      'world_create': 'Create my world',
      'world_building': 'Building your world...',
      'world_stage_building': 'Building your stage...',
      'world_stage_n': 'Stage {n}',
      'world_finale': 'Finale',
      'world_locked_hint': 'Finish the stage before it to unlock',
      'world_needs_internet': 'This stage needs internet the first time',
      'world_progress': '{done} of {total} stages',
      'world_complete': 'World complete — you are its hero!',
      'world_stage_failed': 'This stage had trouble baking. Try again!',
      'stage_complete': 'Stage complete!',
      'world_grew': 'Your world grew!',
      'stage_continue': 'Back to the map',
      'stage_retry': 'Try again',
    ...
    'ar': {
      ...
      // أنواع الألعاب وأنماطها — تظهر لكل مرحلة على خريطة العالم.
      'game_quest_path': 'مغامرة',
      'game_goal_shootout': 'الملعب',
      'game_draw_connect': 'توصيل',
      'game_number_city': 'بلدتي',
      'game_scene_play': 'مختبر العجائب',
      'variant_draw_pass': 'ارسم التمريرة',
      'variant_keeper_save': 'الحارس',
      'variant_bridge_builder': 'الجسر',
      'variant_lantern_lights': 'الفوانيس',
      'variant_sort_streams': 'الفرز',
      'world_new': 'عالم جديد',
      'world_pick_lesson': 'اختر درسًا',
      'world_own_topic': 'موضوعي الخاص',
      'world_own_topic_hint': 'ماذا تريد أن تتعلم؟',
      'world_create': 'أنشئ عالمي',
      'world_building': 'نبني عالمك...',
      'world_stage_building': 'نبني مرحلتك...',
      'world_stage_n': 'المرحلة {n}',
      'world_finale': 'الختام',
      'world_locked_hint': 'أكمل المرحلة السابقة لفتحها',
      'world_needs_internet': 'تحتاج هذه المرحلة إلى الإنترنت في المرة الأولى',
      'world_progress': '{done} من {total} مراحل',
      'world_complete': 'أكملت العالم — أنت بطله!',
      'world_stage_failed': 'تعثّر بناء هذه المرحلة. حاول مجددًا!',
      'stage_complete': 'أكملت المرحلة!',
      'world_grew': 'كبر عالمك!',
      'stage_continue': 'العودة إلى الخريطة',
      'stage_retry': 'حاول مجددًا',
      'classic_games': 'الألعاب الكلاسيكية',
      'best_score': 'الأفضل',
      'plays': 'مرات اللعب',
      'play': 'العب',
      'not_now': 'ليس الآن',
